  ...
  const routerAgent = new RealtimeAgent({
    ...
    instructions: (runContext) => {
      ...
      return [
        ...
        'CRITICAL FOR VOICE: Always provide an immediate voice response FIRST (e.g., "Let me check that for you" or "I\'ll help you with that"), then delegate to the appropriate specialist.',
        'When confident, first acknowledge the request with a brief voice response, then respond with "Routing to <SpecialistName>" and immediately invoke that specialistâ€™s handoff tool.',
