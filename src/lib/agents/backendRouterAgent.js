...
// ============================================================================
export function createBackendEmailOpsAgent(env, tools) {
...
export function createBackendInsightAgent(env, tools) {
    const agent = new Agent({
        name: 'InsightAgent',
        model: BACKEND_MODEL,
        instructions: () => {
...
export function createBackendContactsAgent(env, tools) {
    const agent = new Agent({
        name: 'ContactsAgent',
        model: BACKEND_MODEL,
        instructions: () => {
...
export function createBackendCalendarAgent(env, tools) {
    const agent = new Agent({
        name: 'CalendarAgent',
        model: BACKEND_MODEL,
        instructions: () => {
...
export function createBackendAutomationAgent(env) {
    const agent = new Agent({
...
// ============================================================================
export function createBackendRouterAgent(env, specialists) {
    const agent = new Agent({
        name: 'RouterAgent',
        model: BACKEND_MODEL,
        instructions: () => {
